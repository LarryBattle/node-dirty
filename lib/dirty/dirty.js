// TODO: this._readStream and this._writeStream should be factored out into their own Classes.
if (global.GENTLY)
...
Dirty.prototype.getKeyValueAsJSONString = function (key) {
...
Dirty.prototype._flush = function () {
    ...
    for (var i = 0, length = this._queue.length; i < length; i++) {
        ...
        bundleStr += this.getKeyValueAsJSONString(key) + '\n';
        bundleLength++;
    }
    this.flushing = true;
    this._queue = [];
